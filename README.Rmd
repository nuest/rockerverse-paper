...
hexSticker::sticker(here::here("whaleverse.png"), package = "ROCKERVERSE",
        ...
        filename = here::here("rockerverse.png"))
...
Hex sticker uses the font [Final Frontier Old Style](https://www.fontspace.com/allen-r-walden/final-frontier-old-style) and the [Hubble Ultra-Deep Field](https://en.wikipedia.org/wiki/Hubble_Ultra-Deep_Field) combined with the Docker logo as background.
