...
System dependencies are the domain of Docker, but for a full description of the computing environment one must also manage the R package.
This can be achiedved with MRAN, or with the package **\CRANpkg{renv}** ([https://rstudio.github.io/renv/](https://rstudio.github.io/renv/)), which helps users to manage the state of the R library in a reproducible way, further providing isolation and portability \citep{renv2019}.
