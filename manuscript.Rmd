...
R could also empower webserver since at least 2007, when [RApache](http://www.rapache.net) was presented at the useR! conference. Rapache runs an R interpreter inside the Apache web server and makes it possible and very efficient to build scalable R-based APIs and web services.
