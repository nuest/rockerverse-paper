...
The most important insights involve the 'union' file system used by Docker [REF:FIXME].
...
For instance, we are exploring use of images for Helm [REF:FIXME] orchestrated Kubernetes [REF:FIXME] clusters on the Google Cloud Platform.
