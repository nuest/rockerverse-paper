...
## Clients [Ellis Hughes, Robrecht Cannoodt @rcannood]
...
package_functionalities <- tribble(
  ...
  "AzureContainers", c("execute", "cloud"),
...
knitr::kable(tab, escape = FALSE) %>% 
  ...
  row_spec(0, angle = -90)
# don't print this table just yet, wait for this PR to be merged
...
The goal of **dockermachine** ([https://github.com/cboettig/dockermachine](https://github.com/cboettig/dockermachine)) is to provide a convenient interface to docker-machine from the R command line. This will allow R users to easily create, control, and destroy cloud instances across a wide variety of providers.
-->

<!-- From the cran description
**AzureContainers** ([https://cran.r-project.org/package=AzureContainers](https://cran.r-project.org/package=AzureContainers)) lets you build and deploy containerised services in R, using Docker and Kubernetes. For full functionality, you should have Docker installed, as well as the kubectl and helm commandline tools. Otherwise it is relatively lightweight, requiring neither Powershell nor Python.
-->
...
<!-- from the github description
**harbor** ([https://github.com/wch/harbor](https://github.com/wch/harbor) is an R package for controlling docker containers on local and remote hosts.
-->
