...
This can be used to scale up R code to millions of instances if need be with little or no changes to existing code, as demonstrated by the proof of concept `cloudRunR` ([https://github.com/MarkEdmondson1234/cloudRunR](https://github.com/MarkEdmondson1234/cloudRunR)), which uses Cloud Run to create a scalable R-based API using \CRANpkg{plumber}.
