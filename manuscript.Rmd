...
author:
  ...
  - name: Robrecht Cannoodt
    ...
    address:
      ...
      - Technologiepark 71
      - 9052 Ghent, Belgium
      - \includegraphics[height=\fontcharht\font`\0]{ORCID-iD_icon-vector.pdf} \href{https://orcid.org/0000-0003-3641-729X}{https://orcid.org/0000-0003-3641-729X}
...
**AzureContainers** ([https://cran.r-project.org/package=AzureContainers](https://cran.r-project.org/package=AzureContainers))
<!-- From the cran description
 lets you build and deploy containerised services in R, using Docker and Kubernetes. For full functionality, you should have Docker installed, as well as the kubectl and helm commandline tools. Otherwise it is relatively lightweight, requiring neither Powershell nor Python.
-->
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{figures/liftr-workflow}
