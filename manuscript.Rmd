...
_Bioconductor_ is an open source, open development project for the analysis and comprehension of genomic data [1].
...
The most important insights involve the 'union' file system used by Docker [7].
...
For instance, we are exploring use of images for Helm [8] orchestrated Kubernetes [9] clusters on the Google Cloud Platform.
...
Luke; Yang, Jean Y. H.; Zhang, Jianhua (2004). "_Bioconductor_: open software
...
[7] https://docs.docker.com/storage/storagedriver/overlayfs-driver/#how-container-reads-and-writes-work-with-overlay-or-overlay2
