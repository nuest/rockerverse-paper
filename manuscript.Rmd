...
The project consists of 1741 R software packages, as well as packages containing annotation or experiment data.
...
_Bioconductor_ selects the desired version of R from rocker, adds the BiocManager CRAN package for installing appropriate versions of _Bioconductor_ packages, and creates a _Bioconductor_ docker image with a informative tag (R\_version\_Bioc\_version).
...
Other _Bioconductor_ images for proteomics, metabolomics, and flow cytometry are community maintained.
