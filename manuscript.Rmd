...
To simplify building and maintaining _Bioconductor_ images a Ruby templating engine is used for the `Dockerfile`s.
...
The web application communicates with containers by sending configuration information as a JSON document over standard input. 
