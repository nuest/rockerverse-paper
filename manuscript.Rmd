...
# for submission to arXiv, copy the following files into a new folder and run pdfLaTeX directly on RJwrapper.text (works with RStudio): figures/*, manuscript.tex, RJournal.sty, RJreferences.bib, RJwrapper.tex
# then tip the following files and submit to arXiv:
# - /figures
# - manuscript.tex
# - RJournal.sty
# - RJwrapper.bbl
