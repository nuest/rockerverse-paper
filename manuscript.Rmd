...
It is developed by Oracle, connects R to the GraalVM ecosystem \citep{wikipedia_graal_vm}, and also claims superior performance but also targets full compatibility with base R \footnote{ \href{https://github.com/oracle/fastr}{https://github.com/oracle/fastr}}.
...
As an example, _liftr_ demonstrated its advantage for R Markdown-based computational workflow orchestration, by effortlessly containerizing 18 complex Bioconductor workflows in the DockFlow project (https://dockflow.org) in 2017.
