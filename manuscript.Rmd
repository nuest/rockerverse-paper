...
[`rocker-win`](https://github.com/nuest/rocker-win) is a proof of concept for running R in Windows-based containers.
...
- Fedora > easy to install: https://github.com/ismailsunni/dockeRs
