...
New releases of even just a single piece of software in this pipeline can break the entire workflow, making it difficult for others to use, and making the original the results irreproducible.
...
In many fields we see that a typical unit of research for a container is a research report or journal article, where the container holds the compendium, or self-contained set of data (or connections to data elsewhere) and code files needed to fully reproduce the article [@doi:10.1080/00031305.2017.1375986].
...
Similarly, packages such as containerit and dockerfiler can be used to create a Dockerfile to be archived with a compendium on a data repository (e.g. Zenodo, Dataverse, Figshare, OSF).
A typial compendium Dockerfile will pull a rocker image fixed to a specific version of R, and install R packages from the MRAN repository to ensure the package versions are tied to a specific date, rather than the most recent version.
...
- Website researchcompendia.science
- Gentlemen
- R and friends (what do they recommend)
- rrtools - https://github.com/benmarwick/rrtools
- Some concrete examples, incl. Madjebe 
