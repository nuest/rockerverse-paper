...
## Further Use-case Docker images [NN]

- part of Rocker (if not mentioned in \citet{RJ-2017-065}) ?
  - Binder
...
- `containerit`
- `dockertest`
- `liftr` for OS-level reproducibility [@nanx]
...
## Common work environments [@noamross]
