...
**RStudio** also maintains a set of [Docker images](https://github.com/rstudio/r-docker) for multiple operating systems including SUSE, Ubuntu, CentOS, and Debian.
The image stacks include an [opinionated R installation](https://github.com/rstudio/r-builds) and ensure the R installation and profile is consistent across the different Linux distributions.
The images also install R in a versioned directory and use a minimal set of build and runtime dependencies,
