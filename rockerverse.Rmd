...
The pipeline finishes with triggering a [webhook](https://github.com/analythium/shinyproxy-1-click/blob/master/digitalocean/setup.md#setting-up-webhook) on the server, where the
