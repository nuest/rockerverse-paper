...
**\pkg{googleCloudRunner}** is an interface with [Google Cloud Platform](https://cloud.google.com/) container related services, with tools to make it easier for R users to interact with them for common use cases.  It includes deployment functions for creating R APIs using the Docker based [Cloud Run](https://cloud.run) service; create long running batch jobs calling any Docker image including Rocker via [Cloud Build](https://cloud.google.com/cloud-build/) and schedule services using [Cloud Scheduler](https://cloud.google.com/scheduler/). 
...
As Google Cloud Build itself can run any container, the package \CRANpkg{googleCloudRunner} \citep{cran:googleCloudRunner} demonstrates how R can be used as the control language for one-time or batch processing jobs and scheduling of jobs\footnote{\href{https://code.markedmondson.me/googleCloudRunner/articles/cloudbuild.html}{https://code.markedmondson.me/googleCloudRunner/articles/cloudbuild.html}}.
