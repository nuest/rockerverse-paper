...
\author{by Daniel Nüst, Dom Bennett, Robrecht Cannoodt, Dirk Eddelbuettel, Mark Edmondson, Colin Fay, Ellis Hughes, Sean Lopp, Ben Marwick, Heather Nolis, Jacqueline Nolis, Hong Ooi, Karthik Ram, Noam Ross, Lori Shepherd, Nitesh Turaga, Nan Xiao}
...
into their own workflow seamlessly. The \pkg{outsider} package and
...
Still, at least \emph{on the level of R packages} some consolidation
...
the section on \pkg{outsider}. DE wrote the introduction and the section
...
wrote the section on \pkg{liftr}. All authors approved the final
